                ...
                <div class="row bg-white border-bottom d-none d-lg-flex">
                    ...
                    <div class="col-lg-5 text-right">
                        <div class="d-inline-flex align-items-center p-2">
                            ...
                            <a class="btn btn-sm btn-outline-primary btn-sm-square mr-2" href="https://www.linkedin.com">
                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="public_home.php" class="nav-item nav-link active">Home</a>
                            <a href="public_login.php" class="nav-item nav-link">Login</a>
